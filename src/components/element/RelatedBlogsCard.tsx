...
export default function RelatedBlogsCard({
  id,
  image,
  tag,
  title,
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        <div className="flex flex-col gap-2 h-[280px] lg:h-[268px] mb-4 lg:mb-10">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-start lg:items-center justify-between gap-5 lg:gap-10">
          <Link href={`/blogs/${id}`}>
            <Button className="bg-[#172F5F] rounded-2xl">
              Read More
            </Button>
          </Link>
