...
function TestimonialsSection() {
  ...
  return (
    <div>
      ...
      />
      <h4 className="text-[#959595] mb-24 max-w-[824px] mx-auto text-center text-2xl font-semibold">
        We take pride in delivering real results to businesses of all sizes.
        Here's what our clients have to say about working with us.
      </h4>
      <div className="relative">
        <Carousel
          className="w-full cursor-grab active:cursor-grabbing h-[468px]"
        ...
        >
          <CarouselContent className="-ml-2 w-[1577px] h-[468px]">
            {reviews.map((review) => (
              <CarouselItem
                key={review.id}
                className="pl-2 md:pl-4 basis-full w-[520px] h-[468px]"
              >
                <Card
                  className={`${
                ...
                >
                  <CardContent className="py-32 px-28 relative">
                    {review.id === 1 || review.id === 3 ? (
                      <svg
                        width="169"
                        height="135"
                    ...
                    <div className="flex items-start gap-12">
                      <Avatar
                        className={`size-[216px] border-[12px]  ${
                          review.id === 1 || review.id === 3
                            ? "border-[#2650A0]"
                            : "border-[#55B681]"
                        }`}
                      ...
                      >
                        ...
                        <h3 className="font-extrabold text-2xl mt-12">
                          - {review.name}
                        </h3>
                        <p className="font-extrabold text-2xl">{review.role}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
