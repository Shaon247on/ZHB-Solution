...
function HeroSection() {
  return (
    <div className="py-7 lg:py-20 lg:px-[120px] bg-[#172134] text-white text-center">
      <h1 className="text-xl lg:text-[2.5rem] font-semibold lg:font-bold font-orbitron">
        Empowering Businesses Through <br className="hidden xl:block" />
        Technology
      </h1>
      <p className="text-sm font-semibold text-[#B7B7B7] max-w-[1000px] mx-auto mt-2 mb-10 lg:mb-[40px]">
      ...
      <div className="max-w-[1680px] h-40 lg:min-h-[380px] relative overflow-hidden">
        <Image
          ...
          width={1680}
          height={400}
          className="absolute md:-top-[135px] lg:lg:-top-[200px] left-0 w-full h-full object-cover"
        />
      </div>
    </div>
  );
