...
function MailSection() {
  return (
    <div className="relative bg-[#0f1622] overflow-hidden">
      ...
      <div className="relative z-20 px-6 lg:px-[120px] py-6 lg:py-10">
        <h2 className="text-xl lg:text-2xl font-medium text-[#F8F8F8]">
          Drop us an email to explore for business collaboration or <br className="hidden xl:block"/>career
          Opportunities{" "}
        </h2>
        <div className="bg-[#F8F8F8] h-[2px] w-full my-6" />
