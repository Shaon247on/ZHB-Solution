...
import { Earth, Grow, GrowBlue, Search, Shield } from "@/components/svg/ServicesSVG";
...
const data: cardDataType[] = [
  {
    ...
    title: "Data Accuracy",
    description:
      "Clean, reliable, and trustworthy datasets.",
  },
  {
    icon: <Search />,
  ...
  },
  {
    ...
    title: "Visualization",
    description:
      "Clear dashboards & charts for decision-makers.",
  },
];
