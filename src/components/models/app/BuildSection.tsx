...
function BuildSection() {
  return (
    <div className="py-6 xl:py-20 px-6 xl:px-[120px] flex flex-col xl:flex-row items-start justify-start gap-12">
      <div className="w-full xl:max-w-[518px] xl:block flex lg:w-full gap-6 lg:gap-4">
        <div className="w-1/2 lg:w-[518px] lg:h-full">
          <Image
            ...
            height={388}
            layout="responsive"
            className="object-cover w-1/2 lg:w-[518px] lg:h-[388px] transform scale-x-[-1] rounded-tr-[80px] rounded-bl-[80px]"
          />
        </div>
        <div className="lg:w-[518px] w-1/2 lg:h-full">
          <Image
            src={"/app/image-1.jpg"}
            alt="app image"
            width={518}
            height={388}
            layout="responsive"
            className="object-cover w-1/2 h lg:w-[518px] lg:h-[388px] rounded-tl-[80px] rounded-br-[80px]"
          />
        </div>
      </div>
      <div>
