import { Cloud, Code, Design, Earth, Gear, Grow, Search, Shield } from "@/components/svg/ServicesSVG";

export const WhoCardData = [
  {
    icon: <Shield/>, // Replace with your icon path
    title: "Scalable & Secure Solutions",
    subtitle: "Build future-ready systems with top-level security and performance",
  },
  {
  ...
  },
  {
    ...
    subtitle: "Successfully delivering projects across diverse industries worldwide",
  },
  {
...
export const TopSecviceCardData = [
  {
    ...
    subtitle: "Build high-performance, secure, and scalable websites tailored to your business goals.",
...
const processSteps = [
  ...
  },
  {
    ...
    description: "Our team crafts a detailed project plan, wireframes, and design mockups. We focus on creating intuitive, user-friendly interfaces and clear workflows to bring your idea to life.",
    features: [
  ...
  },
  {
    ...
    description: "Using modern technologies and best coding practices, we develop your solution with scalability and security in mind. ",
    features: [
  ...
  },
  {
    ...
    description: "We launch your solution smoothly, ensuring zero downtime. Post-launch, ",
    features: [
